...
| TD-IDE-002 | P1 | IDE | Comando `build` da extensão usa `build-exe` | S10/S16 |
| TD-UNICODE-001 | P1 | Unicode | `PChar`/buffer wide nativo; IO UTF-8↔UTF-16 explícito | S14/S8\+ |
| TD-PROPERTIES-001 | P1 | OO | Properties com accessor por método (read/write method) | v2.20.0 S12 |
...
```mermaid
flowchart LR
  v217[v2.17.0 S9 ✅] --> v218[v2.18.0 S10 paridade build]
  v218 --> v219[v2.19.0 S11 parser]
  v219 --> v220[v2.20.0 S12 properties avançadas]
